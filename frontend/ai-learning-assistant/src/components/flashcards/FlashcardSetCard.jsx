      ...
      <div className="space-y-4">
        ...
        {totalCards > 0 && (
          <div className="space-y-2">
            ...
            {/* //this the outer bar container basically! */}
            <div className="relative h-2 bg-slate-100 rounded-full overflow-hidden">
              {/* //and this div is basically that green progress line which shows progress. */}
...
// Purpose:
// Displays one flashcard set with its study progress.

// Props:
// flashcardSet -> contains document info, cards, createdAt.
...
// reviewedCount:
// Counts cards having lastReviewed value using filter().
...
// Main Card:
// Entire card is clickable and opens FlashcardManager.

// Progress Bar:
// Width is dynamically set using
// width: `${progressPercentage}%`

// Study Button:
// Also navigates to FlashcardManager.
// stopPropagation() prevents click from bubbling to the parent card.