//check comments for explanation if not understood but easy though
        ...
        <div className="flex flex-col items-center space-y-8">
          ...
          <div className="flex items-center gap-6">
            <button
              ...
              className="group flex items-center gap-2 px-5 h-11 bg-slate-100 hover:bg-slate-200 tex-slate-700 font-medium text-sm rounded-xl transition-all duration-200 disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-slate-100"
            >
              <ChevronLeft
...
// flashcardSets
// Stores all flashcard sets for the current document.

// selectedSet
// Stores the flashcard set currently being viewed.
// null → show list
// object → show flashcard viewer

// currentCardIndex
// Tracks which flashcard is currently displayed.

// fetchFlashcardSets()
// Fetches all flashcard sets from backend.

// useEffect([documentId])
// Loads flashcards whenever a new document is opened.

// handleGenerateFlashcards()
// Calls AI to generate flashcards, then fetches updated sets.

// handleSelectSet()
// Opens a flashcard set and resets to the first card.

// handleNextCard()
// Reviews current card, then moves to the next card.
// Uses modulo (%) to wrap back to the first card.

// handlePrevCard()
// Reviews current card, then moves to the previous card.
// Wraps from first card to last card.

// handleReview()
// Informs backend that the current flashcard has been reviewed.
// Used to increase reviewCount.

// handleToggleStar()
// Toggles the starred status of a flashcard.
// Updates backend and React state without refetching.

// handleDeleteRequest()
// Stores selected flashcard set and opens confirmation modal.

// handleConfirmDelete()
// Deletes selected flashcard set from backend and refreshes the list.

// renderSetList()
// Displays loading spinner, empty state, or all flashcard sets.

// renderFlashcardViewer()
// Displays one flashcard at a time with Previous/Next navigation.

// e.stopPropagation()
// Prevents clicking the delete button from also triggering the parent card's onClick.

// selectedSet ? renderFlashcardViewer() : renderSetList()
// Conditional rendering that switches between the set list and flashcard viewer.