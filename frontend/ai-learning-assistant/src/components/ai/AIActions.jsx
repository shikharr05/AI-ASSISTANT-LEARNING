//check comments below for explanation.
...
// useParams()
// Retrieves documentId from URL.

// loadingAction
// Tracks which AI action is currently loading ("summary" or "explain").

// isModalOpen
// Controls whether the result popup is visible.

// modalTitle
// Stores the heading shown inside the Modal.

// modalContent
// Stores AI-generated Markdown (summary/explanation).

// concept
// Controlled input storing the concept typed by the user.

// handleGenerateSummary()
// Calls backend to generate document summary and displays it in the Modal.

// handleExplainConcept()
// Sends the entered concept to the backend, receives an explanation, and displays it in the Modal.

// loadingAction === "summary"
// Shows spinner only on Summary button.

// loadingAction === "explain"
// Shows spinner only on Explain button.

// Modal
// Reusable popup for displaying AI responses without changing pages.

// MarkdownRenderer
// Converts Gemini's Markdown response into formatted HTML with headings, lists, code blocks, etc.

// Controlled Input
// value={concept} + onChange() keeps the textbox synchronized with React state.
