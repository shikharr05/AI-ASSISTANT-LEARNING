...
// Purpose:
// Displays information about ONE quiz.
// Responsibilities:
// 1. Show quiz details
// 2. Delete quiz
// 3. Show Start Quiz OR View Results button
// depending on whether the quiz is attempted.
...
// onDelete
// Function received from QuizManager.
...
// e.stopPropagation()
// ↓
// Prevents click from affecting parent elements.
//
// onDelete(quiz)
// ↓
// Sends entire quiz object back to parent.
//
// Parent opens Delete Confirmation modal.
...
QuizCard
      ...
      │               │
      ▼               ▼
Delete         Start/View Quiz
      │               │
onDelete()        Link
      │               │
Parent         React Router
      │               │
Delete Modal   New Page
