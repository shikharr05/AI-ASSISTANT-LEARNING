...
|--------------------------------------------------------------------------
| Displays a single uploaded document.
|
| Responsibilities:
| 1. Display document details (title, size, upload time).
| 2. Show flashcard and quiz counts.
| 3. Navigate to the document detail page when clicked.
| 4. Notify the parent component when the delete button is clicked.
|--------------------------------------------------------------------------
*/
...
//converting bytes to correct size like mb kb gb whichever it is.
...
const DocumentCard = ({ document, onDelete }) => {
  ...
  // Navigate to the selected document's detail page.
  const handleNavigate = () => {
    navigate(`/documents/${document._id}`);
  };

  // Stop the click from bubbling to the parent card
  // so clicking Delete doesn't also trigger navigation.
