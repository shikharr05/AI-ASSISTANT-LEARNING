...
// Reusable component shown when there is no data.
//
// Instead of writing separate UIs for:
// - No Documents
// - No Flashcards
// - No Quizzes
// - No Chat History
//
// we use this single component by passing props.
...
// Button is rendered ONLY if:
//
// buttonText exists
// AND
// onActionClick exists.
//
// Otherwise only icon + title + description are shown.
