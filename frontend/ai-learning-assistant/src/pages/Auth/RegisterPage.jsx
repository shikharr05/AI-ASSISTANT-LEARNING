...
import { BrainCircuit, Mail, Lock, ArrowRight, HandFist, User } from "lucide-react";
...
const RegisterPage = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-linear-to-br from-slate-50 via-white to-slate-200">
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                >
                  <Mail className="h-5" strokeWidth={2} />
                </div>
                <input
                  type="email"
                  value={email}
