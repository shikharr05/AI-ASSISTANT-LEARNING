      ...
      <div className="mb-6">
        ...
        <div className="relative h-2 bg-slate-100 rounded-full overflow-hidden">
          <div
            ...
            style={{
              // this is the width of progress bar that keeps on increasing as we solve the questions
...
// Purpose:
// Allows user to attempt a quiz.
//
// Responsibilities:
// 1. Fetch quiz
// 2. Show one question at a time
// 3. Store selected answers
...
// quiz
// Stores complete quiz fetched from backend.

// loading
// Controls loading spinner while fetching quiz.

// currentQuestionIndex
// Index of currently displayed question.

// selectedAnswers
// Object storing user's selected option index.
//
// Example:
// {
//   questionId1: 2,
...
// submitting
// Prevents multiple submissions and shows loading UI.
...
// useEffect runs when page opens (or quizId changes).
//
// Fetches quiz from backend
// and stores it in quiz state.
...
// handleOptionChange()
//
// Updates selectedAnswers while preserving previous answers.
//
// Uses object spread:
//
// {
...
//
// Question changes
// but selected answers remain saved.
...
// ]
//
// Therefore selectedAnswers object
// is converted into formattedAnswers.
//
// Submit quiz
...
// Radio Buttons
// Controlled using selectedAnswers.

// Navigation Dots
// Green = Current
// Light Green = Answered
// Gray = Not Answered

// Last Question
// Shows Submit button instead of Next.
